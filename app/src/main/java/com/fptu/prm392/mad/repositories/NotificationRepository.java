...
public class NotificationRepository {
    ...
    /**
     * Lấy tất cả notifications của user hiện tại, sắp xếp theo thời gian tạo mới nhất
     */
    public void getAllNotifications(OnSuccessListener<List<Notification>> onSuccess,
        ...
        db.collection(COLLECTION_NOTIFICATIONS)
            ...
            .addOnSuccessListener(queryDocumentSnapshots -> {
                ...
                // Sort by createdAt ở client side để tránh lỗi index
     ...
     */
    public void markAsRead(String notificationId, OnSuccessListener<Void> onSuccess,
                          OnFailureListener onFailure) {
        db.collection(COLLECTION_NOTIFICATIONS)
     ...
     */
    public void deleteNotification(String notificationId, OnSuccessListener<Void> onSuccess,
                                  OnFailureListener onFailure) {
        db.collection(COLLECTION_NOTIFICATIONS)
            .document(notificationId)
            .delete()
